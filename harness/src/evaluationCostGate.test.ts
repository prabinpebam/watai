...
const contract: LiveModelEvaluationContract = {
  ...
  budget: { usd: 0, inputTokens: 270_000, outputTokens: 27_000, requests: 45, aiCredits: 270 },
  staging: {
    canaryCaseId: "bounded-read",
    canaryRepetitions: 1,
    maximumWallClockMs: 240_000,
    budget: { usd: 0, inputTokens: 30_000, outputTokens: 3_000, requests: 5, aiCredits: 30 },
